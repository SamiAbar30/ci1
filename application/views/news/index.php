        ...
        <?php if (empty($newsNAV)) : ?>
            ...
            <div class="carousel-item ">
              <a href="<?php echo site_url('') ?>">
                <img class="d-block w-100" src="<?php echo base_url('uploads/2.png') ?>" style="height: 500px;  background-position: center;background-repeat: no-repeat;" alt="First slide">
              </a>
            </div>
            <div class="carousel-item ">
              <a href="<?php echo site_url('') ?>">
                <img class="d-block w-100" src="<?php echo base_url('uploads/sss.jpg') ?>" style="height: 500px;  background-position: center;background-repeat: no-repeat;" alt="First slide">
              </a>
            </div>
